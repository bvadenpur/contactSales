            ...
            <div class="footer-grid">
             ...
             <div class="social-links" id="S-links">
                ...
                <a href="#" class="social-link">
                    <div class="svg">
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none">
                            <path d="M5.68801 6.31665H0.633606V23.9998H5.68801V6.31665Z" fill="#8E9CA1"></path>
                            <path d="M17.6832 6.31665C14.16 6.31665 13.5504 7.60305 13.2624 8.84145V6.31665H8.21277V23.9998H13.2624V13.8959C13.2624 12.2591 14.1504 11.3711 15.7872 11.3711C17.424 11.3711 18.312 12.2399 18.312 13.8959V23.9998H23.3664V15.1582C23.3664 10.1039 22.7088 6.31665 17.6832 6.31665Z" fill="#8E9CA1"></path>
                            <path d="M3.15841 5.0496C4.55281 5.0496 5.68321 3.91921 5.68321 2.5248C5.68321 1.13039 4.55281 0 3.15841 0C1.764 0 0.633606 1.13039 0.633606 2.5248C0.633606 3.91921 1.764 5.0496 3.15841 5.0496Z" fill="#8E9CA1"></path>
                            </svg>
                    </div>
                </a>
                <a href="#" class="social-link">
                    <div class="svg">
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none">
                            <g clip-path="url(#clip0)">
                            <path d="M13.8576 23.9999V13.0511H17.5296L18.0816 8.78391H13.8576V6.06231C13.8576 4.82871 14.1984 3.98391 15.9744 3.98391H18.24V0.143913C17.1442 0.0366488 16.0434 -0.011421 14.9424 -8.69233e-05C11.6832 -8.69233e-05 9.45121 1.98711 9.45121 5.63991V8.78391H5.76001V13.0511H9.44641V23.9999H13.8576Z" fill="#8E9CA1"></path>
                            </g>
                            <defs>
                            <clipPath id="clip0">
